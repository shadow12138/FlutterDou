...
import 'package:flutter_app/model/tv/hot_tv_series_bean.dart';
...
class HotEntertainmentState extends State<HotEntertainmentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _title = ImageUtils.getTitle('热播综艺', count: count, margin: EdgeInsets.symmetric(horizontal: 14));
